...
class BaseAgent:
    def __init__(self, client=None, temperature=0.7, top_k=40, top_p=0.9):
    ...
    def ask(self, prompt: str):
        resp = self.client.generate(prompt, temperature=self.temperature, top_k=self.top_k, top_p=self.top_p)
...
if __name__ == "__main__":
    ...
    agent = BaseAgent(temperature=0.3, top_k=10, top_p=0.8)
